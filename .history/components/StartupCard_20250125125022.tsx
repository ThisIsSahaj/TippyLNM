      ...
      <div className=" p-4">
        ...
        <div className="flex flex-row justify-between items-center mt-10">
          ...
          {isConnected && author?.walletAddress && (
            ...
            <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-3 focus:ring-offset-slate-50">
