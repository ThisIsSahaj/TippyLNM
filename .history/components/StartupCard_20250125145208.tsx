    ...
    <div className="relative overflow-hidden h-full rounded-2xl transition duration-200 group bg-white hover:shadow-xl border border-zinc-200">
      ...
      <div className="flex mt-5 gap-2 px-4">
        ...
        <div className="flex items-center justify-center w-[3rem] h-[1.4rem] rounded-md mt-[-0.5rem] bg-[#444857] text-white">
          <svg className="views_svg" viewBox="0 0 30.5 16.5"><path d="M15.3 0C8.9 0 3.3 3.3 0 8.3c3.3 5 8.9 8.3 15.3 8.3s12-3.3 15.3-8.3C27.3 3.3 21.7 0 15.3 0zm0 14.5c-3.4 0-6.2-2.8-6.2-6.2C9 4.8 11.8 2 15.3 2c3.4 0 6.2 2.8 6.2 6.2 0 3.5-2.8 6.3-6.2 6.3z"></path></svg><span>332</span>
        </div>
      </div>
