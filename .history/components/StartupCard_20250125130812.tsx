        ...
        <div className="flex flex-row justify-between items-center mt-10">
          ...
          {isConnected && author?.walletAddress && (
            ...
            <>
              ...
              <button type="button" className="text-white bg-black hover:bg-black/50 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
