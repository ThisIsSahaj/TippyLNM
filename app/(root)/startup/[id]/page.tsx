...
//         <p className="tag mt-20">{formatDate(post?._createdAt)}</p>

//         <h1 className="  uppercase  px-6 py-3 font-work-sans font-extrabold text-black sm:text-[54px] sm:leading-[64px] text-[36px] leading-[46px] max-w-5xl text-center my-5">
//           {post.title}
//         </h1>
